...
interface ModalProps {
    ...
    onClose: () => void;
    variant?: string;
    buttons: ButtonDataE[]; // Aquí llegan los 12
    estadosdataE?: { text: string; image: string }[]; // Aquí llegan los 4
}

export default function ModalEstado({ buttons, onSelect, onClose, variant, estadosdataE }: ModalProps) {
    return (
