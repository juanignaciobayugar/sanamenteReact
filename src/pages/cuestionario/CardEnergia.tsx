...
function CardEnergia({ onSelect }: CardEnergiaProps) {
  const energiaButtons: ButtonData[] = [
    ...
    { value: "nolose", imgSrc: "/assets/imagenes/cuestionario/tarjetaEnergia/cucharadas-energia/NO LO SE.png" },
  ];
  ...
  return (
    <Card
      ...
      imageSrc="/assets/imagenes/cuestionario/tarjetaEnergia/tarjetaEnergia.png"
